...
<body style=" background: url(http://www.ubuntu-ast.org/largeimages/107/1078179_black-gradient-wallpaper.jpg)100% 100% repeat; width:100%;">
            ...
            <div class="carousel-inner" style="margin-left:80px; margin-right:80px;">
                ...
                <div class="carousel-item">
                    ...
                    <div class="text-box" style="color:white; font-weight:bold;">
                        ...
                        <p class="wow fadeInDown" data-wow-duration="2s">Twitter is meant not for friends and family but for people you actually want to communicate with. You can follow anyone and anyone can follow you. </p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="text-box" style="top:30%; font-weight:bold;">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="2s">Twitter represents one of the quickest and easiest ways to contact a company to get instant customer service. The response you receive may not be as fine-tuned as you would get by speaking to a person on the phone, but at least you won’t be kept on hold for hours before you get that attention. </p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="text-box" style="color:white; font-weight:bold; top:80%; font-weight:bold;">
                        <p class="wow fadeInUp" data-wow-duration="2s">Twitter has proved its worth in recent years as a platform for breaking news. The simplicity of the site means that the first think many people at the scene of a developing news story do is to tweet about it. </p>
                    </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="carousel-item">
                    ...
                    <div class="text-box" style="color:black; font-weight:bold; top:70%; font-weight:bold;">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="2s">Hashtags also figure into this, and most of the Trends listed on Twitter use this simple method of assigning a particular subject to a tweet. You can tailor Twitter trends to suit you, switching from ‘Worldwide’ to those emerging from a particular country. </p>
                    </div>
                </div>
                <div class="carousel-item">
